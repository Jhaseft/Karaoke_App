...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/api/favorites', [FavoritesController::class, 'index'])->name('favorites.index');
    Route::post('/api/favorites', [FavoritesController::class, 'store'])->name('favorites.store');
    Route::delete('/api/favorites/{videoId}', [FavoritesController::class, 'destroy'])->name('favorites.destroy');
});
